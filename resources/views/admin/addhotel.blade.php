          ...
          <div class="row">
            <div class="col">
              <div class="d-flex justify-content-center align-items-center" style="border-radius: 1em; height: 100%;">
                ...
                <label for="firstimg">
                  <img src="{{ asset('images/placeholderimg.png') }}" width="420px" height="350px"
                    style="cursor: pointer;" id="display-image">
                </label>

                <input type="file" id="firstimg" style="display: none; visibility: none;" class="form-control d-none"
                  name="image[]" id="image" multiple onchange="previewImage(this)" />
                @error('image')
                  <div>
                    {{ $message }}
                  </div>
            ...
            <div class="col-7 mt-3">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" placeholder="Enter Hotel Name" class="text-black"
              ...
              <div class="mb-3">
                ...
                <textarea rows="5" class="form-control" placeholder="Enter Hotel Description" class="text-black" id="description"
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" placeholder="Enter Hotel Full Address" id="address"
                  name="full_address">
                @error('address')
                  <div>
                    {{ $message }}
                  ...
                  <div class="col-12">
                    @foreach ($facilities as $facility)
                      <div class="d-inline-flex align-items-center gap-2 me-3">
                        <input class="form-check-input mt-0" type="checkbox" id="inlineCheckbox1"
                          name="{{ $facility->id }}" value="1">
