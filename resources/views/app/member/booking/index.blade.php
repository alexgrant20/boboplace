            ...
            <div class="col-md-8">
              <div class="card mb-3" style="background-color: rgba(255,250,217,255)">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">You have the right to request access to your personal information and to
                    request
                    that we correct or delete it. You also have the right to object to the processing of your
                    personal
                    information, and to request that we restrict the processing of your personal information.
                  </p>
                </div>
              </div>
              <div class="card mb-4">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center gap-1 mb-3">
                    ...
                    <span class="fs-5" style="font-weight: 500">{{ $transaction->hotel->name }}</span>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-5">
                      <img class="img-responsive w-100 h-100"
                        src="{{ asset($transaction->hotel->file->first()->path) }}" alt="">
                    </div>
                    <div class="col-md-7">
                ...
                <div class="row">
                  ...
                  <div class="col-md-7">
                    <div class="d-flex align-items-center gap-1 mb-3 border-2 border-bottom pb-3">
                      ...
                      <span class="fs-3" style="font-weight: 500">{{ $transaction->hotel->name }}</span>
                    </div>
                    <div>
            ...
            <div class="accordion mb-5" id="privay-policy-accordion">
              <div class="accordion-item">
                ...
                <div id="privacyCollapse-1" class="accordion-collapse collapse show"
                  ...
                  <div class="accordion-body">
                    At {{ ucwords($transaction->hotel->name) }}, we are committed to protecting your privacy.
                    This
                    Privacy Policy outlines the types of personal information we collect and how we use it. By
                    using our
                    website and booking a room at our hotel, you accept the practices described in this Privacy
                    Policy.
                  </div>
                </div>
              </div>
...
@section('js-head')
  {!! JsValidator::formRequest('App\Http\Requests\UpdateBookTransactionRequest', '#book-form') !!}
  {!! JsValidator::formRequest('App\Http\Requests\FinalizeBookTransactionRequest', '#payment-form') !!}
  <script>
    $(function() {
