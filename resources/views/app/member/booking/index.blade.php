...
@section('content')
   <div class="bs-stepper">
      <div class="bs-stepper-header" role="tablist">
         ...
         <div class="line"></div>
         <div class="step" data-target="#e-ticket-part">
            <button type="button" class="step-trigger" role="tab" aria-controls="e-ticket-part"
               id="e-ticket-part-trigger">
               <span class="bs-stepper-circle">4</span>
               <span class="bs-stepper-label">E-ticket</span>
            </button>
         </div>
      </div>
      <div class="bs-stepper-content py-4">
                  ...
                  <div class="col-md-8">
                     ...
                     <div class="accordion" id="book-price-accordion">
                        <div class="accordion-item">
                           ...
                           <div id="book-price-summary" class="accordion-collapse collapse"
                              aria-labelledby="book-heading" data-bs-parent="#book-price-accordion">
         ...
         <div id="e-ticket-part" class="content" role="tabpanel" aria-labelledby="ie-ticket-part-trigger"></div>
      </div>
   </div>
