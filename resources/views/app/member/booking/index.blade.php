            ...
            <div class="col-md-8">
              <div class="card mb-3" style="background-color: rgba(255,250,217,255)">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">You have the right to request access to your personal information and to request
                    that we correct or delete it. You also have the right to object to the processing of your personal
            ...
            <div class="accordion mb-5" id="privay-policy-accordion">
              <div class="accordion-item">
                ...
                <div id="privacyCollapse-1" class="accordion-collapse collapse show"
                  ...
                  <div class="accordion-body">
                    At {{ ucwords($transaction->hotel->name) }}, we are committed to protecting your privacy. This
                    Privacy Policy outlines the types of personal information we collect and how we use it. By using our
                    website and booking a room at our hotel, you accept the practices described in this Privacy Policy.
                  </div>
                </div>
              </div>
            </div>
