  ...
  @foreach ($bookingTransaction as $tr)
    <div class="bg-white d-flex align-items-center"
      ...
      <div style="border-radius: 15px;">
        <img class="img-responsive" style="width: 200px" src="{{ asset(@$tr->hotel->file->first()->path) }}" alt="">
      </div>
      <div class="w-100" style="margin-left: 20px">
        ...
        <div class="d-flex justify-content-between">
          ...
          @if ($tr->ticket)
            <a href="{{ asset($tr->ticket) }}" class="btn btn-secondary" target="_blank">Print Ticket</a>
          @else
            <a href="{{ route('booking.edit', $tr->id) }}" class="btn btn-primary">Continue</a>
          @endif
        </div>
