...
{{-- Start Filter By Kota --}}
<div class="p-4 d-flex justify-content-end">
<select name="" id="" class="rounded-pill py-2 px-5 ms-auto">
<option value="">All</option>
<option value=""><a class="dropdown-item" href="/detailHotel/1">Jakarta</a></option>
<option value=""><a class="dropdown-item" href="/categorie/1">Yogyakarta</a></option>
</select>
</div>
                              ...
                              <div class="testimonial-block text-center">
                                    <blockquote class="mb-5">
                                       <p>&ldquo;Donec facilisis quam ut purus rutrum lobortis. Donec vitae odio
                                          quis nisl dapibus
                                          malesuada. Nullam ac aliquet velit. Aliquam vulputate velit imperdiet
                                          dolor tempor
                                          tristique.
